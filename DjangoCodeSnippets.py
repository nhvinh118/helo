...
"""
Project: GlucoseTracker is a web application for keeping tracking of blood sugar levels
management.commands script load_random_glucose_data.py
...
To run: python manage.py load_random_glucose_data jsmith –settings=settings.local
"""
